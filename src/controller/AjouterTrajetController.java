...
public class AjouterTrajetController implements Initializable {
    ...
    @FXML
    private void ClickedAjouterTrajetCourt(ActionEvent event) {
                try {
            Stage st = new Stage();
            // Chargement du fichier FXML
            Parent root = FXMLLoader.load(getClass().getResource("/view/AjouterTrajetCourt.fxml"));
    ...
    @FXML
    private void ClickedAjouterTrajetLong(ActionEvent event) {
                try {
            Stage st = new Stage();
            // Chargement du fichier FXML
            Parent root = FXMLLoader.load(getClass().getResource("/view/AjouterTrajetLong.fxml"));
